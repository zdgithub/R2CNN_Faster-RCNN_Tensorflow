...
def next_batch(dataset_name, batch_size, shortside_len, is_training):
    ...
    if dataset_name not in ['DOTA', 'ship', 'Xray', 'pascal', 'coco', 'DOTA_TOTAL', 'FDDB']:
...
if __name__ == '__main__':
    ...
    with tf.Session(config=config) as sess:
        ...
        print('img_name_batch shape:',img_name_batch_.shape)
	print(img_name_batch_)
        print('img_batch shape:',img_batch_.shape)
	print('gtbox_and_label shape:', gtboxes_and_label_batch_.shape)
        print('debug')
